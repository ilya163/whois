            ...
            if "main" in response:
                ...
                if "rw_domain" in main:
                    if len(main["rw_domain"]) > 0:
                        result = word_worker_dynamic_type(main["rw_domain"],
